<template>
<main v-if="!recipeDetailsVisible && AllMenu" >
    <div class="back-con">
        <a href="#" @click.prevent="goBackToChefDashboard"><img src="/public/images/back to me.png" alt="Back to me"></a>
...
const AllMenu = ref(true)

const emit = defineEmits(['toggleViewMenu', 'toggleMyRecipe', 'toggleRecipeDetails', 'viewRecipeDetails']);
