        ...
        <form class="recipe-form" @submit.prevent="addRecipe">
            <div class="form-header">
                <div class="form-image-con">
                    <input
                        ...
                        name="file"
                    />
                    <label for="file" class="the-image-bttn">
                        <img :src="previewImage" alt="Recipe Image" class="preview-image" />
                    </label>
                </div>
                ...
                <div class="header-back-con">
                    <div class="back-to-recipes-con">
                        <a href="#" class="back-to-recipes" @click.prevent="goToMyRecipes">
            ...
            <div class="form-content-con">
                <div class="form-content-input">
                    <div class="form-content-navbar">
                        <div class="form-navbar-bttn">
                            ...
                            <a 
                                ...
                                @click="activeSection = 'price'"
                            >
                                <div class="form-navbar-img-con">
                                    <img src="/public/images/price.png" alt="Video icon" />
                                </div>
                                <div class="form-navbar-label">
                                    <p>Price</p>
                                </div>
                            ...
                            <a
                                href="#"
                                class="nav-link"
                                :class="{ active: activeSection === 'gcashNumber'}"
                                @click.prevent="setActiveSection('gcashNumber')"
                            >
                                <div class="form-navbar-img-con">
                                    <img src="/public/images/add.png" alt="Video icon" />
                                </div>
                                <div class="form-navbar-label">
                                    <p>Gcash Number</p>
                                </div>
                    ...
                    <div v-show="activeSection === 'price'" class="form-price-inputs-con content">
                        <div class="price-content">
                            <input type="text" placeholder="Price" name="price" v-model="price" />
                        </div>
                    </div>
                    <div v-show="activeSection === 'gcashNumber'" class="form-gcashNumber-inputs-con content">
                        <div class="gcashNumber-content">
                            <input type="text" placeholder="Gcash Number" name="gcashNumber" v-model="gcashNumber" />
                        </div>
                    </div>
                </div>
...
const emit = defineEmits(['toggleViewMenu', 'toggleMyRecipe', 'toggleRecipeDetails', 'showAddRecipe']);
...
.form-description-inputs-con,.form-ingredients-inputs-con ,.form-procedure-inputs-con,.form-video-inputs-con,.form-price-inputs-con{
    width: 45%;
    height: 65%;
    background-color: #B9D5D8;
    border-radius: 30px;
